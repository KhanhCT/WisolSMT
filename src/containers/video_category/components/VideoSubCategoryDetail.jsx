...
import VideoBySubCategory from "./VideoBySubCategory";
...
export class VideoSubCategoryDetail extends Component {
    constructor(props) {
        super(props);
        this.state = {
            isFull: false,
        ...
        if (!location.state || !location.state.currVideo)
    ...
    componentDidMount = () => {
        ...
        // console.log(JSON.parse(defaultSub));
        ...
        this.getListVideoBySubCategory();
    };

    // function create new user_video when seen video
    createNewUserVideo = () => {
        const { currVideo } = this.props.location.state;
        let videoId = parseInt(currVideo);
    ...
    getListVideoBySubCategory = () => {
        // Get param sub_category_id
        const { location } = this.props;
        let subCategoryId = location.state.currVideo.sub_category_id;
        if (subCategoryId) {
    ...
    render() {
        ...
        let renderLstSubDefault = null,
            ...
            renderLstVideoBySubCategory = null,
            renderLstSpeed = null,
        ...
        if (lstVideoBySubCategory.length > 0) {
            renderLstVideoBySubCategory = lstVideoBySubCategory.map(
                (item, i) => {
                    return (
                        <Link
                            key={i}
                                    ...
                                    <div className="jme-controlbar">
                                        <div className="jme-cb-box media-controls">
                                            ...
                                            <div className="cc-container">
                                                ...
                                                >
                                                    <i className="fal fa-closed-captioning" />
                                                </button>
